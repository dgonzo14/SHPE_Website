...
import { RequireApprovedMember } from "./auth/RequireApprovedMember";
...
const PortalEventDetail = lazy(() =>
  import("./pages/portal/EventDetail").then((m) => ({
    default: m.EventDetail,
  })),
);
const CheckIn = lazy(() =>
  import("./pages/portal/CheckIn").then((m) => ({ default: m.CheckIn })),
);
const Points = lazy(() =>
...
const JoinCode = lazy(() =>
  import("./pages/auth/JoinCode").then((m) => ({ default: m.JoinCode })),
);
const Profile = lazy(() =>
  import("./pages/portal/Profile").then((m) => ({ default: m.Profile })),
);
const Settings = lazy(() =>
...
const AdminEventForm = lazy(() =>
  import("./pages/admin/AdminEventForm").then((m) => ({
    default: m.AdminEventForm,
  })),
);
...
const AdminEventAttendance = lazy(() =>
  import("./pages/admin/AdminEventAttendance").then((m) => ({
    default: m.AdminEventAttendance,
  })),
);
const AdminMembers = lazy(() =>
  import("./pages/admin/AdminMembers").then((m) => ({
    default: m.AdminMembers,
  })),
);
const AdminMemberDetail = lazy(() =>
  import("./pages/admin/AdminMemberDetail").then((m) => ({
    default: m.AdminMemberDetail,
  })),
);
...
const AdminAuditLog = lazy(() =>
  import("./pages/admin/AdminAuditLog").then((m) => ({
    default: m.AdminAuditLog,
  })),
);
              ...
              <Suspense fallback={<FullPageLoader />}>
                <Routes>
                  ...
                  <Route element={<RequireAuth />}>
                    {/*
                      The gate between signing in and the portal. Inside
                      RequireAuth (it needs a session) but outside
                      RequireApprovedMember, because a pending member has to be
                      able to reach the one page that admits them.
                    */}
                    <Route element={<AuthLayout />}>
